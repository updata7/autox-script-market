...
我计划在原来基础上继续维护者项目，本项目从[autojs](https://github.com/hyb1996/Auto.js) 并将原项目命名为脚本超市。
你现在看的是原4.1版基础上的项目，后面我将针对项目本身如何开发、运行的进行介绍，欢迎更多开发者参与这个项目维护升级，
最新的[脚本超市地址](https://github.com/kkevsekk1/AutoX), 文档中很多原项目路径，
...
本项目从[hyb1996](https://github.com/hyb1996/Auto.js) autojs 获得,并命名为脚本超市 （autojs 修改版本），
你现在看的是原4.1版本基础上的项目，
