...
public class LoginActivity extends AppCompatActivity {
    ...
    private void setupViews() {
        ...
        settingBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                checkAccessibilityService();
                if (isOpen) {
                    showMessage("Accessibility services--Opened");
    ...
    private void checkAccessibilityService() {
        ...
        String msg = "";
        if (isOpen) {
            msg = "Accessibility services--Opened";
        } else {
            msg = "Accessibility services--Opened";
        }
    ...
    private void reconnect() {
        ...
        if (TextUtils.isEmpty(host) || TextUtils.isEmpty(code)) {
            showMessage("Link address or user code not set");
        }
    ...
    private void regist() {
        if (!checkPermission()) {
            GlobalAppContext.toast("Insufficient permissions, please grant necessary permissions");
            return;
        }
        String host = Pref.getHost("");
        String code = Pref.getCode("");

        MaterialDialog tmpDialog = new MaterialDialog.Builder(this).title("Connect to server")
